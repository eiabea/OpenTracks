...
public class SensorDataCyclingTest {
    ...
    public void compute_speed() {
        ...
        // then
        assertEquals(1.20, current.getValue().first, 2150);
        assertEquals(1.20, current.getValue().second, 0.01);
    }
    ...
    public void compute_speed_rollOverCount() {
        ...
        // then
        assertEquals(1.20, current.getValue().first, 2000);
        assertEquals(2, current.getValue().second, 0.01);
    }
